...
type StreamPoint struct {
	...
	Name  string `protobuf:"bytes,1,opt,name=name,proto3" useJsonFile:"name,omitempty"`
	Value int32  `protobuf:"varint,2,opt,name=value,proto3" useJsonFile:"value,omitempty"`
}
...
type StreamRequest struct {
	...
	Pt *StreamPoint `protobuf:"bytes,1,opt,name=pt,proto3" useJsonFile:"pt,omitempty"`
}
