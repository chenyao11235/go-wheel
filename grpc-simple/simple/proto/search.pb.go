...
type SearchRequest struct {
	...
	Request string `protobuf:"bytes,1,opt,name=request,proto3" useJsonFile:"request,omitempty"`
}
...
type SearchResponse struct {
	...
	Response string `protobuf:"bytes,1,opt,name=response,proto3" useJsonFile:"response,omitempty"`
}
