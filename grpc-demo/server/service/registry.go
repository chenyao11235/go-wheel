...
type Register struct {
    ...
    regKey   string // 节点生成的uuid
    regValue string // 本机IP
}
...
func (register *Register) keepOnline() {
    ...
    for {
        ...
        // 注册到etcd
        if _, err = register.kv.Put(cancelCtx, register.regKey, register.regValue, clientv3.WithLease(leaseGrantResp.ID)); err != nil {
            goto RETRY
        }
...
func InitRegister(regKey, regValue string) (err error) {
    var (
